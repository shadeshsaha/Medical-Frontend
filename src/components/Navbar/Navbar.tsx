    ...
    <div className="py-[16px] border-b-2 borderColor common flex gap-3 items-center justify-between w-full sticky top-0 bg-bgColor z-20">
      ...
      <Link href={"/"} className="md:w-full">
        <Image
          ...
          // width={400}
          // height={400}
          className="md:w-[130px] md:h-[70px] w-[80px] h-[51px]"
        />
      </Link>
        ...
        {userLogged ? (
          ...
          <Link href={"/login"}>
            <div className="relative inline-flex group">
              <div
                className="absolute transitiona-all duration-1000 opacity-70 -inset-px  from-[#44BCFF] via-[#FF44EC] to-[#FF675E] rounded-xl animate-tilt"
